...
model.add(Dropout(0.2))
# model.add(GRU())
# model.add(GRU(128, activation='tanh', inner_activation='hard_sigmoid', return_sequences=True))
# model.add(Dropout(0.5))

# model.add(GRU(256, activation='tanh', inner_activation='hard_sigmoid', return_sequences=False))
# model.add(Dropout(0.5))

# model.add(GRU(128, activation='tanh', inner_activation='hard_sigmoid', return_sequences=False))
# model.add(Dropout(0.5))
...
ModelPath = 'model_3c_0817.json'
fd = open(ModelPath, 'w')
fd.write(json_string)
fd.close()
model.save_weights('model_3c_0817.h5')#80p = test accuracy
print ('save model , ok!!!')
