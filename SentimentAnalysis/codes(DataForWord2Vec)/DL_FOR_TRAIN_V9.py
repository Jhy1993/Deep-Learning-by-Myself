...
Version: 1.9
Update:  calculate time cost
1.8 some optimization
...
class DL_for_train:
    ...
    def __init__(self,
                ...
                nb = 2,
                min_count = 5,
                ModelPath = 'model_3c_0831.json',
                WeightPath = 'model_3c_0831.h5',
    ...
    def get_model(self, x, y, embeddings_matrix):
        print ('start keras...')
        y = np_utils.to_categorical(y, 3)
        max_features = embeddings_matrix.shape[0]
    ...
    def GO(self):
        ...
        model = self.get_model(x, y, embeddings_matrix)
